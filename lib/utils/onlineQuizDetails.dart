...
class OnlineQuizPageDetails extends StatefulWidget {
  @override
  _OnlineQuizPageDetailsState createState() => _OnlineQuizPageDetailsState();
}

class _OnlineQuizPageDetailsState extends State<OnlineQuizPageDetails> {
  @override
              ...
              child: LayoutBuilder(builder:(context , constraints){
                return ListTile(
                  title: Padding(
                    ...
                    child: Row(
                      children: [
                        Text("Online Quiz Name" , style: AppTextStyle.headerStyle2,),
                  ...
                  subtitle: Column(
                    ...
                    children: [
                      ...
                      Text("Result" , style: AppTextStyle.headerStyle2,),
                    ],
                  ),
